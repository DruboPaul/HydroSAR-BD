<<<<<<< HEAD:legacy/audit_validation_points.py
import pandas as pd
import numpy as np
import json
...
file_path = r"data\Sample_Points\Balanced_Validation_Points_2025_Full.csv"
...
if __name__ == "__main__":
    audit_points(file_path)
>>>>>>> 2f4a07f (Finalize methodologies, figures, datasets, and scripts for manuscript submission):scripts/audit_validation_points.py
