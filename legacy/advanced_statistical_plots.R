<<<<<<< HEAD:legacy/advanced_statistical_plots.R
# ═══════════════════════════════════════════════════════════════════
...
2. R_seasonal_ribbon.png\n")
3. R_divisional_heatmap.png\n")
>>>>>>> 2f4a07f (Finalize methodologies, figures, datasets, and scripts for manuscript submission):scripts/advanced_statistical_plots.R
