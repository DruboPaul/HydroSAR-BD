...
function runMonthly() {
    ...
    try {
        ...
        if (selMonth === 'Total Occurrence') {
            ...
            // Create white background layer to cover satellite imagery
            var whiteBackground = ee.Image(1).visualize({ palette: ['FFFFFF'] }).clip(regionGeom);
            Map.addLayer(whiteBackground, {}, 'White Background', true);

            // Add occurrence layer on top of white background
