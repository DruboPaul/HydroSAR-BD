...
\begin{figure}[H]
    ...
    \caption{\textbf{Supplementary Figure S10.} Confusion matrix for SAR-derived surface water classification against 6,000 field-verified reference points (2025).}
    \label{fig:s_cm}
\end{figure}
